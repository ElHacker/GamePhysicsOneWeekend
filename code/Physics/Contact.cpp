...
void ResolveContact( contact_t & contact ) {
	...
	// Find the normal direction of the velocity with respect to the normal of the coliision
	...
	const Vec3 inertiaB = (invWorldInertiaB * ra.Cross(relativeVelTang)).Cross(rb);
